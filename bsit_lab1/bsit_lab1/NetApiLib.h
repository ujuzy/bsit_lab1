...
public:
	NetApiLib()
	{
		...
		GetUsers = (NET_API_STATUS(*)(LPCWSTR, DWORD, DWORD, LPBYTE*, DWORD, LPDWORD, LPDWORD, PDWORD))GetProcAddress(hLib, "NetUserEnum");
	...
	NET_API_STATUS(*GetUsers)(LPCWSTR, DWORD, DWORD, LPBYTE*, DWORD, LPDWORD, LPDWORD, PDWORD);
